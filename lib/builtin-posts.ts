...
- Номер рятувальників TOPR: 601 100 300.`;
...
- TOPR mountain rescue: 601 100 300.`;
...
export const BUILTIN_POSTS: Post[] = [
  {
    ...
    slug: "rysy-weekend",
    title_uk: "Рисі (2499 м) за вікенд: із Кракова громадським транспортом",
    title_en: "Rysy (2499 m) in a weekend: from Krakow by public transport",
    excerpt_uk:
