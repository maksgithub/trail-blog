...
export const BUILTIN_POSTS: Post[] = [
  {
    ...
    slug: "rysy-weekend",
    title_uk: "Рисі (2499 м) за вікенд: із Кракова через Словаччину",
    title_en: "Rysy (2499 m) in a weekend: from Krakow through Slovakia",
    excerpt_uk:
    ...
    waypoints: [
      ...
      { lat: 49.2969, lng: 19.964, title: "Закопане — пересадка на бус" },
      ...
      { lat: 49.154, lng: 20.081, title: "Popradské pleso" },
      { lat: 49.122, lng: 20.0575, title: "Štrbské Pleso — електричка TEŽ" },
